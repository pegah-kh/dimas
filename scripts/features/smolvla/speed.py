...
def build_parser():
    ...
    s = sub.add_parser(
        "train-regression-vlm-clf",
        help="Train VLM regression steering vector with sklearn SVM gate",
    )
    ...
    s = sub.add_parser(
        "train-diff-means-vlm-clf",
        help="Train VLM diff-of-means steering vector with sklearn SVM gate",
    )
    s.add_argument("--low-q", type=float, default=0.25)
    s.add_argument("--high-q", type=float, default=0.75)
    s.add_argument("--svm-C", type=float, default=0.1)
    ...
    s = sub.add_parser(
        "train-regression-fm-clf",
        help="Train FM regression steering vector with sklearn SVM gate",
    )
