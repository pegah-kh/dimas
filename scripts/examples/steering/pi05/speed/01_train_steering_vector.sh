...
# extraction produced by extraction/pi05/FM/extract_baseline.sh.
#
...
# — see fm_steering_generate_OT in scripts/features/pi05/speed.py: as soon as
# any task ends up in its internal test_episodes split, it gets concatenated
...
# methods exist in scripts/features/pi05/speed.py and are worth trying as
...
SPEED_SCRIPT="$XL_VLAS_ROOT/scripts/features/pi05/speed.py"
